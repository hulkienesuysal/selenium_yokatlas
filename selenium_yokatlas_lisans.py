...
db = SqliteDatabase("yokatlas_lisans.db")
...
site="https://yokatlas.yok.gov.tr/lisans-univ.php?u=1004"
saniye=1
...
while i<=bolumsayisi: 
    try:
        ...
        #sleep(saniye)
        #driver.find_element_by_xpath('/html/body/div[2]/div[1]/div[6]/div[2]/h2/strong/a[2]').click()
        sleep(saniye)
        scrolltarget('//*[@id="h1060"]/a') 
        driver.find_element_by_xpath('//*[@id="h1060"]/a').click()
        sleep(saniye)
        lisesayisi=len(driver.find_elements_by_xpath('//*[@id="icerik_1060"]/table/tbody/tr'))
        print(lisesayisi)
        o=2
        while o<lisesayisi+1:
            scrolltarget('//*[@id="icerik_1060"]/table/tbody/tr[{}]/td[1]'.format(o))
            liseler=driver.find_element_by_xpath('//*[@id="icerik_1060"]/table/tbody/tr[{}]/td[1]'.format(o)).text
            print(liseler)
